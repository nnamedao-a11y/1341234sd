        ...
        {!success ? (
          <>
            ...
            <form className="git-modal-form" onSubmit={submit} noValidate>
              ...
              <div className="git-field git-field--budget">
                <label htmlFor="git-budget" className="git-label">
                  Budget <span className="git-req">*</span>
                </label>
                <div className="git-budget-row">
                  <input
                    id="git-budget"
                    type="number"
                    inputMode="numeric"
                    min="0"
                    step="100"
                    className="git-input git-input--budget"
                  ...
                  />
                  <div className="git-currency" role="group" aria-label="Currency">
                    {["EUR", "USD"].map((c) => (
                      <button
                        type="button"
                        key={c}
                        className={`git-currency-btn ${form.currency === c ? "is-active" : ""}`}
                        onClick={() => setForm((s) => ({ ...s, currency: c }))}
                        data-testid={`git-currency-${c}`}
                      >
                        {c}
                      </button>
                    ))}
